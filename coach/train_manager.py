...
class Train_ArgParser(argparse.ArgumentParser) :
    def __init__(self, **kwargs) :
        ...
        cfg_args.add_argument('--config', type=str, metavar="FILE", help='path to config file', 
                                                        default='./configs/pretrain.yaml')
        cfg_args.add_argument('--model_config', type=str, metavar="FILE", help='path to model config file', 
                                                        default='./configs/model/srresnet.yaml')
